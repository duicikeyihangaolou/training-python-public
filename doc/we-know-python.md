...
参考：[Ask me python with AI](askmepythonwithAI.md)

### 1.1 简介：关于 Python 你需要了解的二三事
...
总之是被广泛应用于某些领域，Python 最常见的领域是：运维脚本、自动化测试、Web 编程、AI 相关。
...
#### 1.1.5 AI 时代，我们应该如何入门 Python？

[AI 已来，或乘风破浪，或倾覆浪底。](https://blog.csdn.net/maodouzi/article/details/149183886)

1. 拥抱变化，不必恐惧，恐惧多源于无知。
2. 越了解，越能恰如其分地使用。
3. AI 技术在不断变化中，需要持续地了解和随之恰当使用。

**AI 大模型辅助编程的本质是什么？** 加权求和 / 大数定理 / 连接主义。

**编程的本质是什么？** 把连接主义的模糊映射到符号主义的精确。
...
1. 从基础语法开始，逐步掌握 Python 编程的核心概念和技术。
2. 用 Python 编写规范，逐步掌握规范的编写方法。
3. 用 AI 辅助生成代码，逐步掌握 AI 辅助编程的方法。
...
> - 图中的 python 版本不一定是 3.6，更高版本亦可，当前推荐 3.10（最低维护版本是 3.9）
...
4. [使用 AI 辅助编码](#36-使用-ai-工具快速生成代码)，比如 Trae
5. 使用更强大的 AI 编程大模型工具，Cursor / GitHub Copilot / Claude Code
6. 代码规范：[Google Python 风格指南](https://google.github.io/styleguide/pyguide.html)
...
参考：Python Django Demo，[Github](https://github.com/duicikeyihangaolou/lab-django) 或
